...
def load_users():
    ...
    except FileNotFoundError:                                       # "my concept was to make a login part, but my code and making the program taking so much errors so i just pull to chatgpt for the solution and then i use this filenotfounderror promt. -- for this use I am extremely sorry."
        return {}  
